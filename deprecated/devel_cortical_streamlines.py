...
in_surf = '/misc/lauterbur/lconcha/TMP/glaucoma/fs_glaucoma/sub-74277/surf/lh_white_fsnative_scanner.surf.gii'
#in_surf_pial = '/misc/lauterbur/lconcha/TMP/glaucoma/fs_glaucoma/sub-74277/surf/lh_pial_fsnative_scanner.surf.gii'
in_surf_pial = 'no'
in_vec = '/misc/lauterbur/lconcha/TMP/glaucoma/fs_glaucoma/sub-74277/mri/laplace-wm_vec.nii.gz'
nsteps = 200
step_size = 0.1
out_tck = '/tmp/full.tck'

nsteps    = int(nsteps)
step_size = float(step_size)

print('Starting the creation of streamlines with the following arguments:')
...
if connect_to_pial :
    ...
    Fpial = surf.get_arrays_from_intent('NIFTI_INTENT_TRIANGLE')[0].data
