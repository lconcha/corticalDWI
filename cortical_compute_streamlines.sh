...
help() {
  echo "
  Usage: $(basename $0) <subjID> [target_type] [nsteps] [step_size]
...
do
  ...
  echolor green "[INFO] surf_white: $surf_white"
  echolor green "[INFO] surf_pial: $surf_pial"
  echolor green "[INFO] in_vec: $in_vec"
  ...
  echolor cyan "[INFO] Running cortical_streamlines.py"
