...
fcheck=${SUBJECTS_DIR}/${subjID}/dwi/dki/lh_${target_type}_mk.tsf
if [ -f $fcheck ]
then
...
metrics="fa ga md ad rd mk ak rk"
...
do
  ...
  do
    ...
    map=${SUBJECTS_DIR}/${subjID}/dwi/dki/${metric}.nii.gz
    tsfout=${SUBJECTS_DIR}/${subjID}/dwi/dki/${hemi}_${target_type}_${metric}.tsf
    if [ -f $tsfout ]
    then
